...
-- Copies the nx TypeScript check command for the current project
function M.CopyTsCheckCmd()
  ...
  -- Construct the TypeScript check command
  local cmd = string.format('yarn nx run %s:tsCheck', name)
